...
import { AreaChart, Area,PieChart,Pie,Cell,BarChart,Bar,LineChart, Line, XAxis, YAxis, CartesianGrid, Tooltip, Legend } from 'recharts';
        ...
        {showSim && 
          ...
          <div>
            ...
            >
              ...
              <Tooltip />
              <Area type="monotone" dataKey="delta"  stroke="#8884d8" fill="#8884d8" />
              <Area type="monotone" dataKey="omicron"  stroke="#82ca9d" fill="#82ca9d" />
            ...
            <div>
              <h6 style={styles.centerText}>infectiousness Over Time</h6>
              <BarChart
             width={1500}height={600}data={rdata}  margin={{
              top: 5,
              right: 30,
              left: 20,
              bottom: 5,
              ...
              >
                <CartesianGrid strokeDasharray="3 3" />
                <XAxis dataKey="name" tickCount={20 } label={{ value: 'Time(minutes)', position: 'insideBottom', offset: -10 }}/>
                <YAxis  label={{ value: 'Total Infectiousness', angle: -90, position: 'insideLeft' }}/>
                <Tooltip />
                <Legend />
                <Bar dataKey="delta"  fill="#8884d8" />
               <Bar dataKey="omicron"  fill="#82ca9d" />
              </BarChart>
            </div>}
            {selectedChart === "pie" &&
            <div>
